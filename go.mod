...
require (
	...
	chainguard.dev/melange v0.60.0
	...
	// Pinned: later revisions switch from gopkg.in/yaml.v3 to go.yaml.in/yaml/v4,
	// which is incompatible with chainguard.dev/melange/pkg/renovate.
...
require (
	...
	github.com/chainguard-dev/go-pkgconfig v0.0.0-20260625083649-3332107431aa // indirect
